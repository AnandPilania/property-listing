                    ...
                    <div class="footer-widget mb-30">
                        ...
                        <ul class="footer-social-icons">
                            @foreach ($social_icon as $item)
                                <li><a href="{{ __($item->data_values->url) }}">@phpecho $item->data_values->social_icon;
                                @endphp </a></li>
                            @endforeach
                    ...
                    <div class="footer-widget mb-30">
                        ...
                        <div class="footer-widget__recent">
                            <div class="footer-widget__location">
                                <ul>
                                    <li> <i
                                            class="fa-solid fa-location-dot"></i><span>{{ __($contact->data_values->contact_details) }}</span>
                                    </li>
                                    <li><i class="fa-solid fa-phone"></i><span><a
                                                href="javascript:void(0)">{{ __($contact->data_values->contact_number) }}</a></span>
                                    </li>
                                    <li><i class="fa-solid fa-envelope"></i><span><a
                                                href="javascript:void(0)">{{ __($contact->data_values->email_address) }}</a></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
