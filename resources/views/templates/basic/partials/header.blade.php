            ...
            <div class="row">
                <div class="col-lg-6 col-md-7">
                    <div class="header_top_left">
                        <ul>
                            <li>
                                <a href="tel::{{ __($contact->data_values->contact_number) }}">
                        ...
                        <div class="main_menu">
                            <nav id="mobile-nav">
                                <ul class="menu_list_box">
                                    <li><a class="{{ Route::is('home') ? 'active' : '' }}"
                                    ...
                                    <li><a href="{{ route('plans') }}"
                                            class='{{ Route::is('plans') ? 'active' : '' }}'>@lang('Plans')</a></li>
                                    ...
                                    @guest
                                        <li><a href="{{ route('user.login') }}"
                                                class='{{ Route::is(' user.login') ? 'active' : '' }} theme_btn'><span
                                                    class="btn_title"> <i class="fa-regular fa-user"></i> @lang('Login')
                                                </span></a></li>
                                    @endguest
