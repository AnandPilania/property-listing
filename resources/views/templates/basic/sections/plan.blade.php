...
$user=App\Models\PlanSubscribe::where('user_id',
@auth()->user()->id)->with('getUserPlanSubscribe')->orderBy('id','desc')->first();
      ...
      <div class="col-xl-3 col-lg-4 col-md-6">
        <div class="single_plan text-center mb-30 ">
          ...
          <div class="single_plan__body mb-35">
            <ul>
              <li><i class="fa-solid fa-check"></i>{{__($item->listing_limit)}} @lang('Listings Per ') {{$item->validity}} days</li>
