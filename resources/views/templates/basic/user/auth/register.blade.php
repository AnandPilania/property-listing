...
@section('content')
    ...
    <section class="login_area login_bg pt-70 pb-80 md-pt-50 md-pb-50"
        style="background-image:url({{ asset($activeTemplateTrue . 'images/error-bg.jpg') }})">
        <div class="container">
                    ...
                    <div class="col-lg-6 col-lg-6 col-md-10">
                        <div class="register_wrapper">
                            ...
                            <div class="form-group profile mb-15">
                                ...
                                <div class="single-input">
                                    <input type="email" id="last_name" name="email" value="{{ old('email') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group profile mb-25">
                                        <div class="nice_select_wrapper mb-30 style_1">
                                            <label class="state">@lang('Country')<span
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group profile mb-25">
                                        <div class="form-group single-input">
                                            <label class="state">@lang('Mobile')<span
                                                    class="text-danger">*</span></label>
                                            <div class="mobile-input-wrap">
                                                ...
                                                <input type="number" name="mobile" value="{{ old('mobile') }}"
                                                    class="mobile-number checkUser" required>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group profile mb-25">
                                        ...
                                        <div class="single-input">
                                            <input id="state"type="password" name="password" placeholder="Password"
                                                required>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group profile mb-15">
                                        ...
                                        <div class="single-input">
                                            <input type="password" id="last_name"
                            ...
                            <div class="register_bottom mb-15">
                                <button class="theme_btn style_1"type="submit" id="recaptcha"><span
                                        class="btn_title">@lang('Register')<i
