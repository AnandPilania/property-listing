                                        ...
                                        <div class="listing_title">
                                            ...
                                            <div class="mt-0">
                                                <p><i class="fa fa-map-marker pr-2 ti-location-pin mrg-r-5"></i>
                                                    {{ __($properties->location->name) }},
                                                    {{ __($properties->city->name) }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="single_top_wrap__detail mr-2">
                                        <div class="detail_wrapper">
                                            <div class="listing-title-bar">
                                                ...
                                                <div class="mt-0">
                                                    <p>{{ __(@$properties->propertyInfo->square_feet) }} @lang('sqft')
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="single_featured__img">
                                            <div class="featured_wrapper featured_active_slider">
                                                ...
                                                @else
                                                    <div class="featured_single_slide">
                                                        <img src="{{ getImage(getFilePath('property') . '/') }}"
                                                            alt="Image">
                                                    </div>
                                                @endif
                                            </div>
                                ...
                                <ul class="social-share">
                                    @auth
                                        <button type="button" class="btn btn-link" data-bs-toggle="modal"
                                            ...
                                            <i class="fa fa-share-alt"></i> &nbsp; Share to conversation</a>
                                        </button>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('conversation.share_prop_to_conversation') }}"
                                                            method="post">
                                                            @csrf
                                                            @if (isset($chats))
                                                                <h5>Select Converstions to share to.</h5>
                                                                <input type="hidden" name="prop_id"
                                                                    value="{{ $properties->id }}">
                                                                <ul class="list-group" style="width: 100%">
                                                                    @foreach ($chats as $chat)
                                                                        <li class="list-group-item text-start">
                                                                            <input type="checkbox" name="chat_id[]"
                                                                                class="form-check-input"
                                                                                value="{{ $chat->id }}" id="chat_item_{{ $chat->id }}">
                                                                            <label for="chat_item_{{ $chat->id }}">
                                    ...
                                    @endauth
                                    <li><a
                                            href="https://www.facebook.com/share.php?u={{ Request::url() }}&title={{ slug($properties->title) }}"><i
                                                class="fab fa-facebook-f"></i></a></li>
                                    <li><a
                                            href="https://twitter.com/intent/tweet?status={{ slug($properties->title) }}+{{ Request::url() }}"><i
                                                class="fab fa-twitter"></i></a></li>
                                    <li><a
                                            href="https://www.linkedin.com/shareArticle?mini=true&url={{ Request::url() }}&title={{ slug($properties->title) }}&source=propertee"><i
                                                class="fab fa-linkedin-in"></i></a></li>
                                </ul>
                                @if ($properties->user_id == Auth::id())
                                    <a href="{{ route('user.promote.property', $properties->id) }}"><span
                                            class="promote-btn">@lang('Promote this Property')</span></a>
                                @endif
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="home" aria-selected="true">@lang('Details')</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                                data-bs-target="#profile" type="button" role="tab"
                                                aria-controls="profile" aria-selected="false">@lang('Floor Plan')</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="contact-tab" data-bs-toggle="tab"
                                                data-bs-target="#contact" type="button" role="tab"
                                                aria-controls="contact" aria-selected="false">@lang('Video')</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="location-tab" data-bs-toggle="tab"
                                                data-bs-target="#location" type="button" role="tab"
                                                aria-controls="location" aria-selected="false">@lang('Location')</button>
                                        </li>
                                    </ul>
                                                    ...
                                                    <div class="single homes-content details mb-30">
                                                        <ul class="propery_listing_single__details mb-20">
                                                            <li>
                                                                ...
                                                                <span
                                                                    class="det">{{ __(@$properties->propertyInfo->room) }}</span>
                                                            </li>

                                                            <li>
                                                                <span class="span_bold">@lang('Kitchen'):</span>
                                                                <span
                                                                    class="det">{{ __(@$properties->propertyInfo->kitchen) }}</span>
                                                            </li>
                                                            <li>
                                                                <span class="span_bold">@lang('Bathroom'):</span>
                                                                <span
                                                                    class="det">{{ __(@$properties->propertyInfo->bathroom) }}</span>
                                                            </li>
                                                            <li>
                                                                <span class="span_bold">@lang('Unit'):</span>
                                                                <span
                                                                    class="det">{{ __(@$properties->propertyInfo->unit) }}</span>
                                                            </li>
                                                            <li>
                                                                <span class="span_bold">@lang('Floor'):</span>
                                                                <span
                                                                    class="det">{{ __(@$properties->propertyInfo->floor) }}</span>
                                                            </li>

                                                            <li>
                                                                <span class="span_bold">@lang('Square feet'):</span>
                                                                <span
                                                                    class="det">{{ __(@$properties->propertyInfo->square_feet) }}</span>
                                                            </li>
                                        ...
                                        <div class="tab-pane fade" id="profile" role="tabpanel"
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12">
                                                <div class="propery_listing_single mb-30 single_featured">
                                                    ...
                                                    <img src="{{ getImage(getFilePath('property') . '/' . @$properties->propertyInfo->floor_plan) }}"
                                                        alt="Poroperty">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="single_featured similar-properties-gap-x mb-30">
                                    ...
                                    <div class="single_featured__content">
                                        ...
                                        <div class="location_date">
                                            <p><i class="fas fa-map-marker-alt fa-xs"></i>
                                                {{ __($item->location->name) }}, {{ __($item->city->name) }}
                                            </p>
                                            <p><i class="far fa-clock fa-md"></i> {{ diffForHumans($item->created_at) }}
                                            </p>
                                        </div>
                                        <h4 class="mb-3 mt-2 text--muted"><a
                                                href="{{ route('property.details', [slug($item->title), $item->id]) }}">{{ __($item->title) }}</a>
                                        </h4>
