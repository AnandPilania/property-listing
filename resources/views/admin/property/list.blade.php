                                ...
                                @forelse($properties as $propertie)
                                    <tr>
                                        <td data-label="@lang('Title - City - Location')">
                                            ...
                                            <span> {{ __($propertie->location->name) }}, {{ __($propertie->city->name) }}
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <span>{{ showAmount(@$propertie->propertyInfo->price) }}
                                        ...
                                        <td data-label="@lang('Action')">
                                            ...
                                            <a href="{{ route('admin.property.info.edit', $propertie->id) }}"
                                                class="icon-btn btn--primary ml-1" data-toggle="tooltip"
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.property.create') }}" class="btn btn-sm btn--primary addCity"><i
