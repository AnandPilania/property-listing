                ...
                <form action="" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            {{-- <div class="row mb-5">
                                <div class="col-md-3 col-xs-4 d-flex align-items-center">
                                    <label> @lang('Site Gradient Color ')</label>
                                </div>
                                <div class="col-md-9 col-xs-12">
                                    <div class="input-group">
                                        <div class="random-color">
                                            ...
                                            <div class="codess"></div>
                                                ...
                                                <input type="color" class="gradient_color1" name="gradient_color1">
                                                <input type="color" class="gradient_color2" name="gradient_color2">
