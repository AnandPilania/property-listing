...
@section('panel')
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center m-b-0">
                                            <div class="col">
                                                ...
                                                <h3 class="m-b-0">{{ $general->cur_sym }}{{ showAmount($totalDeposit) }}
                                                </h3>
                                            </div>
                                            <div class="col-auto">
                ...
                <div class="col-xl-8">
                    <div class="card p-2 mb-3">
                        <ul class="d-flex flex-wrap gap-1">
                            ...
                            <li class="flex-grow-1 flex-shrink-0">
                                <a class="d-block btn bg--primary bal-btn" href="javascript:void(0)" data-bs-toggle="modal"
                                    data-bs-target="#kycModal" data-act="kyc"><i class="las la-user-circle"></i>
                                    @lang('Document KYC')</a>
                            </li>
    ...
    <div id="kycModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"> <span>@lang('Document KYC')</span></h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="las la-times"></i>
                    </button>
                </div>
                <div>
                    ...
                    <input type="hidden" name="act">
                    <div class="modal-body">
                        @if ($user->doc_kyc_doc_file && $user->doc_kyc_status == 'accepted')
                            <p>User KYC Complete <i class="text-success fa fa-check"></i></p>
                            <table class="table">
                                <tr>
                                    <th>Document Type</th>
                                    <td>{{ $user->doc_kyc_document_type }}</td>
                                </tr>
                                <tr>
                                    <th>Document File</th>
                        ...
                        @elseif($user->doc_kyc_doc_file && $user->doc_kyc_status == 'rejected')
                            <p>User KYC Has been Rejected previously <i class="text-danger fa fa-times"></i></p>
                            <table class="table">
                                <tr>
                                    <th>Document Type</th>
                                    <td>{{ $user->doc_kyc_document_type }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $user->doc_kyc_rejection_reason }}</td>
                                </tr>
                            </table>
                            <br>
                        @elseif($user->doc_kyc_doc_file && $user->doc_kyc_status == 'pending')
                            <p>KYC Pending <i class="text-warning fa fa-check"></i></p>
                            <table class="table">
                                <tr>
                                    <th>Document Type</th>
                                    <td>{{ $user->doc_kyc_document_type }}</td>
                        ...
                        @elseif(!$user->doc_kyc_doc_file && $user->doc_kyc_status == 'pending')
                            <p>No KYC Documnet Uploaded</p>
                            <br>
                        @endif
                        <br>
                        <hr>
                        <h5>Modify User Document KYC Status</h5>
                        <form action="{{ route('admin.users.modify.kyc', $user->id) }}" method="POST">
                            @csrf
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="reason">Reason(only required for rejection)</label>
                                <textarea name="reason" id="reason" maxlength="1024" class="form-control"></textarea>
                            </div>
                            <br>
                            <button type="submit" class="btn btn--primary btn-global">@lang('Save')</button>
                        </form>
