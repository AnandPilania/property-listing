...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(
        function () {
    ...
    // Users Manager
    Route::controller('ManageUsersController')->name('users.')->prefix('manage/users')->group(
        function () {
            ...
            Route::get('document/kyc', 'userDocumentKYC')->name('document.kyc');
            ...
            Route::post('modify/kyc/{id}', 'modifyKYC')->name('modify.kyc');
    ...
    // Manage city
    Route::controller('CityController')->group(
        function () {

            Route::get('city/list', 'index')->name('city.index');
            Route::post('city/store', 'store')->name('city.store');
            Route::post('city/update', 'update')->name('city.update');
        }
    );

    // Manage location
    Route::controller('LocationController')->group(
        function () {

            Route::get('location', 'index')->name('location.index');
            Route::post('location/store', 'store')->name('location.store');
            Route::post('location/update', 'update')->name('location.update');
        }
    );

    // Manage propertyType
    Route::controller('PropertyTypeController')->group(
        function () {

            Route::get('propertytype', 'index')->name('propertytype.index');
            Route::post('propertytype/store', 'store')->name('propertytype.store');
            Route::post('propertytype/update', 'update')->name('propertytype.update');
        }
    );

    // plan
    Route::controller('PlanController')->group(
        function () {
    ...
    // featured plan
    Route::controller('FeaturedPlanController')->group(
        function () {
            Route::get('featured/plan', 'index')->name('featured.plan.index');
            Route::post('featured/plan/store', 'store')->name('featured.plan.store');
            Route::post('featured/plan/update', 'update')->name('featured.plan.update');
        }
    );

    // Subscriber
    Route::controller('SubscriberController')->group(
        function () {
    ...
    // Deposit Gateway
    Route::name('gateway.')->prefix('payment/gateways')->group(
        function () {

            // Automatic Gateway
            Route::controller('AutomaticGatewayController')->group(
                function () {
            ...
            // Manual Methods
            Route::controller('ManualGatewayController')->group(
                function () {
    ...
    // DEPOSIT SYSTEM
    Route::name('deposit.')->controller('DepositController')->prefix('manage/deposits')->group(
        function () {
    ...
    // Report
    Route::controller('ReportController')->group(
        function () {
    ...
    // Admin Support
    Route::controller('SupportTicketController')->prefix('support')->group(
        function () {
    ...
    // Language Manager
    Route::controller('LanguageController')->prefix('manage')->group(
        function () {
    ...
    Route::controller('GeneralSettingController')->group(
        function () {
            // General Setting
    ...
    Route::name('setting.notification.')->controller('NotificationController')->prefix('notifications')->group(
        function () {
            //Template Setting
    ...
    // property
    Route::name('property.')->controller('PropertyController')->prefix('property')->group(
        function () {

            Route::get('/', 'index')->name('index');
            Route::get('create', 'create')->name('create');
            Route::post('create', 'store')->name('store');
            Route::get('info/edit/{id}', 'propertyEdit')->name('info.edit');
            Route::post('info/update/{id}', 'update')->name('info.update');
            Route::post('image/delete', 'imageRemove')->name('image.delete');
        }
    );


    // Plugin
    Route::controller('ExtensionController')->group(
        function () {
    ...
    // Frontend
    Route::name('frontend.')->prefix('frontend')->group(
        function () {

            Route::controller('FrontendController')->group(
                function () {
                    Route::get('templates', 'templates')->name('templates');
            ...
            // Page Builder
            Route::controller('PageBuilderController')->prefix('manage')->group(
                function () {
